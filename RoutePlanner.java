...
public class RoutePlanner {
    // graph stores city connections and distances
    private final Map<String, Map<String, Integer>> graph = new LinkedHashMap<>();

    public RoutePlanner() {
        // adding all default routes between cities with distances (km)
    ...
    // helper method to add route in both directions
    ...
    // allows user to add custom route
    ...
    public String[] shortestRoute(String start, String end) {
        ...
        // priority queue for shortest distance selection
        ...
        // transport suggestions based on distance
